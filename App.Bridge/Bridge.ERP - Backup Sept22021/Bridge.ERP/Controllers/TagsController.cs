...
namespace Bridge.ERP.Controllers
{
    public class TagsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TenantId,TagName,TagType,IsDelete,IsActive,TagDescription")] Tags tags)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TenantId,TagName,TagType,IsDelete,IsActive,TagDescription")] Tags tags)
        {
            if (id != tags.Id)
            {
                return NotFound();
