...
namespace Bridge.ERP.Controllers
{
    ...
    public class ListsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TenantId,ListName,ListType,IsDelete,IsActive,ListDescription")] List lists)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TenantId,ListName,ListType,IsDelete,IsActive,ListDescription")] List lists)
        {
            if (id != lists.Id)
            {
                return NotFound();
