...
namespace Joylet.API.Controllers
{
    ...
    public class CartsController : ControllerBase
    {
        ...
        public async Task<IEnumerable<ResultCartDto>> GetCartsResultAsync(int? id)
        {
            ...
            var cartTotalResult = _cartService.CalculateItemsCartById(cartsQuantityPriceResult);
            var deliveryFees = await _cartService.GetDeliveryFees();
            var cartTotalResultWithShip = _cartService.CalculateDeliveryFee(cartTotalResult, deliveryFees);
            return cartTotalResultWithShip;
        }
